            ...
            <div className="flex flex-col items-center w-full">
                ...
                <div className="mt-20 flex justify-center w-2/3 lg:flex-row md:flex-col flex-col">
                    ...
                    <span className="lg:w-1/3 sm:w-full text-slate-500 font-bold dark:text-slate-300 lg:mt-5">
                        ...
                        This made many computers, especially chromebooks, unable to compile and run PBASIC on their already owned hardware,
                        which is used particularly in education. This is why Skewax exists. <br /><br />
                ...
                <div className="flex justify-center pt-20 lg:pt-10">
                    ...
                    <span className="w-1/3 sm:w-full text-slate-500 font-bold dark:text-slate-300 ml-10 md:mt-14 lg:mt-14">
